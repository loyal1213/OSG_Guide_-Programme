	...
	case(osgGA::GUIEventAdapter::KEYDOWN):
		{
			...
			//前进
			if (ea.getKey() == osgGA::GUIEventAdapter::KEY_Up || ea.getKey () == osgGA::GUIEventAdapter::KEY_W || ea.getKey () == 'w')//up
			{
			...
			//后退
			if (ea.getKey() == osgGA::GUIEventAdapter::KEY_Down || ea.getKey () == osgGA::GUIEventAdapter::KEY_S || ea.getKey () == 's' )//down
			{
				ChangePosition(osg::Vec3 (0, -m_fMoveSpeed * sinf(osg::PI_2+m_vRotation._v[2]), 0)) ;
			...
			//向左
			if (ea.getKey () == osgGA::GUIEventAdapter::KEY_Shift_L || ea.getKey () == 'a')
			{
			...
			//向右
			if (ea.getKey () == osgGA::GUIEventAdapter::KEY_Shift_R || ea.getKey () == 'd') 
			{
				ChangePosition(osg::Vec3 (0,-m_fMoveSpeed * cosf(osg::PI_2+m_vRotation._v[2]), 0)) ;
			...
			//改变屏角
			if (ea.getKey() == osgGA::GUIEventAdapter::KEY_Page_Up || ea.getKey() == 'f')//F
			{
				m_fAngle -= 0.2 ;
			...
			if (ea.getKey() == osgGA::GUIEventAdapter::KEY_Page_Down || ea.getKey() == 'g')//G
			{
				m_fAngle += 0.2 ;
