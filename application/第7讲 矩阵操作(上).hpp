...
osg::AnimationPath* createAnimationPath1(const osg::Vec3& center,float radius,double looptime)
{
...
osg::Node* createBase1(const osg::Vec3& center,float radius)
{
...
osg::Node* createMovingModel1(const osg::Vec3& center, float radius)
{
	float animationLength = 10.0f;

	osg::AnimationPath* animationPath = createAnimationPath1(center,radius,animationLength);
...
osg::ref_ptr<osg::Group> createModel1(bool overlay, osgSim::OverlayNode::OverlayTechnique technique)
{
	...
	osg::ref_ptr<osg::Node> baseModel = createBase1(osg::Vec3(center.x(), center.y(), baseHeight),radius);
	osg::ref_ptr<osg::Node> movingModel = createMovingModel1(center,radius*0.8f);
...
int TestMatrix()
{
	...
	osg::ref_ptr<osg::Group> model = createModel1(overlay, technique);
	if (!model)
	{
		return 1;
	}
