...
static osg::ref_ptr< osg::Node >  marker = osgDB::readNodeFile("red_flag.osg");
...
int TestTriangles()
{
	...
	osg::ref_ptr<osg::Group> s_root = new osg::Group;

	osg::ref_ptr<osg::Node> node = osgDB::readNodeFile("gdal_interp.earth");
